...
![GRP State After Exception](/assets/images/part-05-0/gpr_state_after_exception.png)

and that the Coprocessor 0 registers related to exception handling have been written to.

![COP State After Exception](/assets/images/part-05-0/cop0_state_after_exception.png)
