...
There's one further wrinkle that needs discussing before we can move onto presenting code.
...
As previously discussed the instruction in the branch-delay slot 
...
[^2]: [Old New Thing MIPS 4000 Branch Delay Slots][oldnewthing-branch-delay-slots]

[wiki-pipeline-stall]: https://en.wikipedia.org/wiki/Pipeline_stall
[oldnewthing-branch-delay-slots]: https://devblogs.microsoft.com/oldnewthing/20180411-00/?p=98485
